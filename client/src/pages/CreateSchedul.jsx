...
<div className="absolute transform -translate-x-0 translate-y-0 top-1  ml-[800px] ">
      ...
      <Link to="/">
        <button className="bg-green-700  bg-opacity-80  shadow-slate-400 w-32 h-10 border  border-slate-300 rounded-lg text-white hover:opacity-85 ml-[800px]  font-extralight  text-opacity-75">My Schedule</button>
        </Link>
        </div>
      ...
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex justify-center items-center mt-6">
          <form className="flex flex-col  gap-4" onSubmit={handleSubmit} >
            ...
            <div>
            <h3 className="font-semibold text-white ml-1">Workout</h3>
            <select
          ...
          >
            ...
            {formData.state.map((exercise, index) => (
                <div key={index}>
                  <h3 className="font-semibold text-gray-600 ml-1">Exercise {index + 1}</h3>
          ...
          <button className="bg-green-700 border bg-opacity-80 border-slate-300 shadow-xl shadow-slate-400 text-white p-3 rounded-lg w-[460px] h-11 font-serif text-opacity-90 hover:opacity-90" type="button" onClick={handleAddExercise}>Add Exercise</button>
            <button
